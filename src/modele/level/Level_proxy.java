...
/** La classe Level_proxy est une copie de level à laquelle la classe lemming va accéder. Grace à ce système, un lemming
 * ne peut pas modifier directement un level, cela renverrait une exception. C'est la classe GameMaster qui a les droits.
 *
 * @author  Philippe Leleux
 * @version 1.0
 */

public class Level_proxy implements Level_itf {
    //Attributs
    ...
    //Constructeur
    public Level_proxy(Level_itf level) {
     ...
     */
    public void destroy(Position positionDuLemming, Position[] positionDesBlocs) throws TentativeDeModificationFrauduleuseException {
	throw new TentativeDeModificationFrauduleuseException("destroy");
    }
     ...
     * depart.
     */
    public void addBlocks(Element_itf block) throws TentativeDeModificationFrauduleuseException {	
	throw new TentativeDeModificationFrauduleuseException("addBlocks");
    }
	...
	throw new TentativeDeModificationFrauduleuseException("deleteBlockingLemming");
    }	
	...
	string += "position initiale : (" + this.getPositionTrappe().getX() + ", " + this.getPositionTrappe().getY() + ")\n";
