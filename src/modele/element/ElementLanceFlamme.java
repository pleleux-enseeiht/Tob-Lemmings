...
/** La classe Level ElementLanceFlamme implante la structure d'un bloc de type lance-flamme.
 *
 * @author  Philippe Leleux
 * @version 1.0
 */

public class ElementLanceFlamme implements Element_itf {

//Attributs
	private Position position;	// Position de l'element dans la grille

//Constructeur
	public ElementLanceFlamme(Position position) {
...
// Affichage du niveau
	...
	public String toString() {
		String string;
		string = "Element de type lance-flamme : (" + this.position.getX() + ", " + this.position.getY() +")";
		return string;
	}
