...
/** La classe Level ElementSemiDestructibleDroite implante la structure d'un bloc de type element semi-destructible <.
 *
 * @author  Philippe Leleux
 * @version 1.0
 */

public class ElementSemiDestructibleDroite implements Element_itf {

//Attributs
	private Position position;	// Position de l'element dans la grille

//Constructeur
	public ElementSemiDestructibleDroite(Position position) {
